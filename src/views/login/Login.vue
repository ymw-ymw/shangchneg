		...
		<div class="login_box">
			...
			<el-form ref='login' label-width="0px" class='centent_from' :model="form" :rules="loginrules">
				...
				<el-form-item prop='loginname'>
					<el-input v-model="form.loginname" prefix-icon='iconfont icon-yonghu'></el-input>
				</el-form-item>
				<!-- 密码 -->
				<el-form-item prop='loginpasword'>
					<el-input v-model="form.loginpasword" type='password' prefix-icon="iconfont icon-mima"></el-input>
				</el-form-item>
				<!-- 按钮 -->
		...
		methods: {
			onSubmit() {
				this.$refs.login.validate(valid => {
					if (valid) {
						postlogin(this.form.loginname, this.form.loginpasword).then(res => {
